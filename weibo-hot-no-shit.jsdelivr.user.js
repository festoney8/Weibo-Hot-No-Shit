...
// @downloadURL  https://cdn.jsdelivr.net/gh/festoney8/weibo-hot-no-shit@release/weibo-hot-no-shit.jsdelivr.user.js
// @updateURL    https://cdn.jsdelivr.net/gh/festoney8/weibo-hot-no-shit@release/weibo-hot-no-shit.jsdelivr.user.js
// @match        *://weibo.com/*
// @match        *://www.weibo.com/*
// @match        *://s.weibo.com/*
...
// @exclude      *://www.weibo.com/tv/*
// @exclude      *://www.weibo.com/aj/*
// @exclude      *://www.weibo.com/hot/mine*
// @exclude      *://www.weibo.com/hot/search*
...
(function (vue) {
  ...
  t(" .setting-menu[data-v-3519dc98]{display:grid;grid-template-columns:128px 1fr;gap:6px;min-width:620px}.setting-menu__tabs[data-v-3519dc98]{display:flex;flex-direction:column;gap:6px;padding-right:8px;border-right:1px solid #eceef2}.setting-menu__tab[data-v-3519dc98]{border:1px solid transparent;border-radius:4px;background:transparent;color:#5c6570;font-size:13px;text-align:left;padding:8px 10px;cursor:pointer}.setting-menu__tab.is-active[data-v-3519dc98]{background:#f6f8fc;border-color:#d9dee7;color:#1f2d3d;font-weight:600}.setting-menu__editor[data-v-3519dc98]{min-width:0;padding:10px;display:flex;flex-direction:column}.setting-menu__meta[data-v-3519dc98]{align-items:baseline;margin-bottom:8px}.setting-menu__title[data-v-3519dc98]{margin:0;font-size:14px;color:#1f2d3d}.setting-menu__textarea[data-v-3519dc98]{flex:1;resize:none;border:1px solid #d7dce5;border-radius:4px;padding:8px;line-height:1.5;font-size:14px;color:#1f2d3d;min-height:280px;outline:none}.setting-menu__textarea[data-v-3519dc98]:focus{border-color:#8aa4ff;box-shadow:0 0 0 2px #637dff26}html[data-theme=light] .hot-sidebar[data-v-d38d9cb0],html:not([data-theme]) .hot-sidebar[data-v-d38d9cb0]{--hot-color-bg: #fff;--hot-color-border: #eceef2;--hot-color-title: #1f2d3d;--hot-color-text: #1f2d3d;--hot-color-desc: #8b97a6;--hot-color-muted: #9aa4b2;--hot-color-icon: #939393;--hot-color-tab-bg: #f3f4f6;--hot-color-tab-active-bg: #fff;--hot-color-tab-text: #8c98a7;--hot-color-tab-active-text: #1f2d3d;--hot-color-rank: #ff8200;--hot-color-rank-top3: #f26d5f;--hot-color-scrollbar-thumb: rgba(148, 163, 184, .3)}html[data-theme=dark] .hot-sidebar[data-v-d38d9cb0]{--hot-color-bg: #111318;--hot-color-border: #222833;--hot-color-title: #d2d6dd;--hot-color-text: #bfbfbf;--hot-color-desc: #aaaaaa;--hot-color-muted: #7d838d;--hot-color-icon: #7a808a;--hot-color-tab-bg: #0a0d12;--hot-color-tab-active-bg: #161b23;--hot-color-tab-text: #858b95;--hot-color-tab-active-text: #d5dae2;--hot-color-rank: #ff9800;--hot-color-rank-top3: #ff6c5f;--hot-color-scrollbar-thumb: rgba(126, 132, 143, .38)}body:has([state=noside]) aside[data-v-d38d9cb0]{display:none}aside[data-v-d38d9cb0]{position:fixed;top:68px;left:calc(50vw + 274px)}.hot-sidebar[data-v-d38d9cb0]{width:290px;height:calc(100vh - 85px);display:flex;flex-direction:column;background:var(--hot-color-bg);border:1px solid var(--hot-color-border);border-radius:4px;overflow:hidden}.hot-sidebar__header[data-v-d38d9cb0]{display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px}.hot-sidebar__title[data-v-d38d9cb0]{margin:0;font-size:16px;color:var(--hot-color-title);font-weight:500}.hot-sidebar__title-group[data-v-d38d9cb0]{display:inline-flex;align-items:center}.hot-sidebar__setting[data-v-d38d9cb0]{display:inline-flex;margin-left:6px;align-items:center;justify-content:center;width:24px;height:24px;padding:4px;border:none;background:transparent;color:var(--hot-color-icon);opacity:0;pointer-events:none;transition:opacity .16s ease;cursor:pointer}.hot-sidebar__header:hover .hot-sidebar__setting[data-v-d38d9cb0]{opacity:1;pointer-events:auto}.hot-sidebar__setting-icon[data-v-d38d9cb0]{width:24px;height:24px}.hot-sidebar__refresh[data-v-d38d9cb0]{border:none;background:transparent;color:var(--hot-color-muted);padding:0;display:inline-flex;align-items:center;gap:4px;font-size:14px;cursor:pointer}.hot-sidebar__refresh[data-v-d38d9cb0]:disabled{cursor:default;opacity:.8}.hot-sidebar__refresh-icon[data-v-d38d9cb0]{width:14px;height:14px;font-size:14px;animation:spin-click-d38d9cb0 .45s linear;color:var(--hot-color-icon)}.hot-sidebar__refresh-icon.is-spinning[data-v-d38d9cb0]{animation:spin-d38d9cb0 .9s linear infinite}@keyframes spin-click-d38d9cb0{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.hot-sidebar__tabs[data-v-d38d9cb0]{margin:0 16px;background:var(--hot-color-tab-bg);border-radius:4px;padding:3px;display:grid;grid-template-columns:1fr 1fr;gap:4px}.hot-sidebar__tab[data-v-d38d9cb0]{border:none;background:transparent;color:var(--hot-color-tab-text);border-radius:4px;font-size:13px;padding:2px 0;cursor:pointer}.hot-sidebar__tab.is-active[data-v-d38d9cb0]{background:var(--hot-color-tab-active-bg);color:var(--hot-color-tab-active-text)}.hot-sidebar__list-wrap[data-v-d38d9cb0]{margin-top:8px;padding:0 10px 12px;flex:1;min-height:0;overflow-y:auto;scrollbar-width:thin;scrollbar-color:var(--hot-color-scrollbar-thumb) transparent}.hot-sidebar__list-wrap[data-v-d38d9cb0]::-webkit-scrollbar{width:3px}.hot-sidebar__list-wrap[data-v-d38d9cb0]::-webkit-scrollbar-track{background:transparent}.hot-sidebar__list-wrap[data-v-d38d9cb0]::-webkit-scrollbar-thumb{background:var(--hot-color-scrollbar-thumb);border-radius:999px}.hot-list[data-v-d38d9cb0]{list-style:none;margin:0;padding:0}.hot-list__end[data-v-d38d9cb0]{margin:6px 0;text-align:center;font-size:12px;color:var(--hot-color-muted);letter-spacing:.4px;-webkit-user-select:none;user-select:none}.hot-list__item[data-v-d38d9cb0]{display:flex;align-items:center;height:40px}.hot-list__rank[data-v-d38d9cb0]{display:inline-flex;justify-content:center;line-height:1.2;width:24px;flex:0 0 24px;font-size:18px;color:var(--hot-color-rank);font-variant-numeric:tabular-nums;font-family:var(--vc-font-family);-webkit-user-select:none;user-select:none}.hot-list__rank.is-top3[data-v-d38d9cb0]{font-weight:700;font-style:italic;color:var(--hot-color-rank-top3)}.hot-list__link[data-v-d38d9cb0]{display:flex;align-items:center;flex:1;min-width:0;text-decoration:none;height:2em}.hot-list__link:hover .hot-list__word[data-v-d38d9cb0],.hot-list__link:hover .hot-list__desc[data-v-d38d9cb0]{color:var(--hot-color-rank)}.hot-list__word[data-v-d38d9cb0]{display:inline-block;flex:1;line-height:1.2;margin-left:6px;min-width:0;font-size:14px;color:var(--hot-color-text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.hot-list__desc[data-v-d38d9cb0]{font-size:13px;font-weight:600;margin-left:8px;line-height:1.2;color:var(--hot-color-desc);white-space:nowrap;-webkit-user-select:none;user-select:none}.setting-menu-dialog[data-v-d38d9cb0]{border:none;border-radius:0;padding:0;margin:0;min-width:0;max-width:none;background:transparent;overflow:visible}.setting-menu-dialog[data-v-d38d9cb0]::backdrop{background:transparent}.setting-menu-panel[data-v-d38d9cb0]{margin:0;border-radius:10px;padding:16px;min-width:640px;background:#fff;box-shadow:0 16px 40px #0f172a33}.setting-menu-dialog__close[data-v-d38d9cb0]{position:absolute;top:8px;right:10px;width:32px;height:32px;border:none;border-radius:8px;background:transparent;color:#7f8998;font-size:28px;line-height:1;cursor:pointer}.setting-menu-dialog__close[data-v-d38d9cb0]:hover{background:#f3f4f6}@keyframes spin-d38d9cb0{0%{transform:rotate(0)}to{transform:rotate(360deg)}} ");
...
function useWindowSize(options = {}) {
  ...
  const __unplugin_components_0 = _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d38d9cb0"]]);
  const _sfc_main = {};
